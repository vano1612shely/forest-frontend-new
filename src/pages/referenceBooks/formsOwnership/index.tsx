...
import { directoryOwnershipOptions } from '@/api/referenceBooks'

import { columns } from '@/pages/referenceBooks/formsOwnership/columns.tsx'
...
export const FormsOwnershipPage = () => {
	const { navigate } = useRouter()
	const search = useSearch({
		strict: false
	}) as any
	const { data, isLoading } = useQuery(directoryOwnershipOptions())
	...
	return (
		<div>
			<ReferenceBookNavigation current_page={'formsOwnership'} />
			<Card className='page__table-card-full-size'>
				<div className='page__table-header'>
					<h1 className='page__title'>Довідник форм власності</h1>
