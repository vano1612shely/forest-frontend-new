...
import { directoryTaxesOptions } from '@/api/referenceBooks'

import { columns } from '@/pages/referenceBooks/directoryTaxes/columns.tsx'
...
export const DirectoryTaxesPage = () => {
	const { navigate } = useRouter()
	const search = useSearch({
		strict: false
	}) as any
	const { data, isLoading } = useQuery(directoryTaxesOptions())
	...
	return (
		<div>
			<ReferenceBookNavigation current_page={'directoryTaxes'} />
			<Card className='page__table-card-full-size'>
				<div className='page__table-header'>
					<h1 className='page__title'>Довідник форм оподаткування</h1>
